...
build:
	sudo -E cargo build --release --manifest-path filesyscall_catch/Cargo.toml
...
clean:
	sudo -E cargo clean --manifest-path filesyscall_catch/Cargo.toml